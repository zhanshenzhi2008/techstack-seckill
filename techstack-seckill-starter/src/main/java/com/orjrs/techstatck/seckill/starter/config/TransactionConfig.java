 ...
 */
package com.orjrs.techstatck.seckill.starter.config;
 ...
 */
@Configuration
@MapperScan(value = {"com.orjrs.techsatck.seckill.infrastructure.mapper"})
@ComponentScan(value = {"com.orjrs.techstack.seckill"})
